...
マイズを行うと楽だ。  
以下に、つつじが丘おもちゃ病院で開発してきたファームウェアの代表事例を紹介する。(今回はATTINY402のプロジェクト）  
...
今回は、つつじが丘おもちゃ病院で開発してきたファームウェアの代表事例のうち、newATTINY402の基板を起こしましたので、  
その内容を公開したいと思います。他のおもちゃ病院のドクターさんに参考になれば幸いです。  
